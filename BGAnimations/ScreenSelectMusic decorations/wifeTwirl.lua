...
local frameX = 10 
local frameY = 322 + capWideScale(get43size(120), 90)
...
local t = Def.ActorFrame {
	...
	Def.Quad {
		InitCommand = function(self)
			self:xy(frameX, frameY - 146):zoomto(110, 214):halign(0):valign(0):diffuse(getMainColor("tabs"))
		end
	},
	Def.Quad {
		InitCommand = function(self)
...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Large") .. {
		Name = "MSD",
		InitCommand = function(self)
			self:xy(frameX + 58, frameY - 80):halign(0.5):zoom(0.5):maxwidth(110 / 0.6)
		end,
		MintyFreshCommand = function(self)
			if song then
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "Goalll",
		InitCommand = function(self)
			self:xy(capWideScale(frameX + 140,frameX + 450), frameY + 27):zoom(0.6):halign(0.5):valign(0)
	...
	LoadFont("Common Normal") .. {
		InitCommand = function(self)
			self:xy(capWideScale(frameX + 10,frameX + 15), frameY + 15):zoom(0.4):halign(0)
		end,
		MintyFreshCommand = function(self)
			if song and score then
	...
	Def.BPMDisplay {
		...
		Name = "BPMDisplay",
		InitCommand = function(self)
			self:xy((capWideScale(get43size(384), 400)) - 310, 200):halign(1):zoom(0.50):maxwidth(50)
		end,
		MintyFreshCommand = function(self)
			if song then
				self:visible(true)
	...
	LoadFont("Common Large") .. {
		...
		InitCommand = function(self)
			self:xy((capWideScale(get43size(384), 400)) - 280, 220):visible(true):halign(1):zoom(
...
local function radarPairs(i)
	local o = Def.ActorFrame {
		...
		LoadFont("Common Normal") .. {
			InitCommand = function(self)
				self:xy(frameX + 13, frameY - 72 + 13 * i):zoom(0.5):halign(0):maxwidth(120)
			end,
			MintyFreshCommand = function(self)
				if song then
		...
		LoadFont("Common Normal") .. {
			InitCommand = function(self)
				self:xy(frameX + 105, frameY + -72 + 13 * i):zoom(0.5):halign(1):maxwidth(60)
			end,
...
t[#t + 1] =LoadFont("Common Normal") .. {
	InitCommand = function(self)
		self:xy((capWideScale(get43size(384), 400)) - 282, 200):halign(1):zoom(0.50)
	end,
...
t[#t + 1] = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			...
			self:xy(20, 312):zoom(0.5):halign(0)
			self:diffuse(getMainColor("positive"))
		end,
		MouseDownCommand = function(self, params)
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			self:xy(20, 295):halign(0):zoom(0.5)
...
t[#t + 1] =
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		...
		BeginCommand = function(self)
			self:xy(20, 278):zoom(0.5):halign(0):settext(translated_info["OpenSort"])
			self:diffuse(getMainColor("positive"))
		end,
		MouseDownCommand = function(self, params)
			if params.event == "DeviceButton_left mouse button" then
