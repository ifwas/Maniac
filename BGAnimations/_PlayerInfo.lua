...
local noteCount = 0
local numfaves = 0
local AvatarX = SCREEN_CENTER_X - 300
...
local function UpdateTime(self)
	...
	self:GetChild("SessionTime"):settextf("%s: %s", "tiempo perdido a lo pendejo", SecondsToHHMMSS(sessiontime))
end
...
t[#t + 1] = Def.ActorFrame {
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "loginlogout",
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, AvatarY + 17):halign(1):zoom(0.4) -- self:xy(SCREEN_WIDTH - 3, AvatarY + 29):halign(1):zoom(0.4)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "LoggedInAs",
		InitCommand = function(self)
			self:xy(AvatarX + 55, AvatarY + 8):halign(0):zoom(0.5)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		InitCommand = function(self)
			self:xy(SCREEN_CENTER_X - capWideScale(125,175) - 70, AvatarY - 15):halign(0):zoom(0.5)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
		...
		SetCommand = function(self)
			...
			self:y(AvatarY + (online and 18 or 0) + 22)
	...
	UIElements.TextToolTip(1, 1, "Common Normal") .. {
		Name = "refreshbutton",
		InitCommand = function(self)
			self:xy(SCREEN_WIDTH - 3, AvatarY + 29):halign(1):zoom(0.4) -- self:xy(SCREEN_WIDTH - 3, AvatarY + 17):halign(1):zoom(0.4)
		end,
		BeginCommand = function(self)
			self:queuecommand("Set")
		end,
...
t[#t + 1] = Def.ActorFrame {
	...
	LoadFont("Common Normal") .. {
		Name = "SessionTime",
		InitCommand = function(self)
			self:xy(SCREEN_CENTER_X - 245, SCREEN_BOTTOM - 8):halign(0):valign(1):zoom(0.45)
		end
	}
}
